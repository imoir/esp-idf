...
static esp_err_t start_provisioning(wifi_prov_security_t security, const void *wifi_prov_sec_params,
...
{
    return start_provisioning(security, wifi_prov_sec_params, service_name, service_key, true);
}

esp_err_t wifi_prov_mgr_start_provisioning(wifi_prov_security_t security, const void *wifi_prov_sec_params,
                                           const char *service_name, const char *service_key)
{
    return start_provisioning(security, wifi_prov_sec_params, service_name, service_key, false);
}
